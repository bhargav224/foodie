...
export class RecipeIngredientDeleteDialog extends React.Component<IRecipeIngredientDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.recipeIngredientEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="foodieChefApp.recipeIngredient.delete.question">Are you sure you want to delete this RecipeIngredient?</ModalBody>
        <ModalFooter>
          <Button color="secondary" onClick={this.handleClose}>
            <FontAwesomeIcon icon="ban" />
            &nbsp; Cancel
          </Button>
          <Button id="jhi-confirm-delete-recipeIngredient" color="danger" onClick={this.confirmDelete}>
