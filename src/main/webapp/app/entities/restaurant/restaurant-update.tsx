...
export class RestaurantUpdate extends React.Component<IRestaurantUpdateProps, IRestaurantUpdateState> {
  ...
  render() {
    const { restaurantEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="foodieChefApp.restaurant.home.createOrEditLabel">Create or edit a Restaurant</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
