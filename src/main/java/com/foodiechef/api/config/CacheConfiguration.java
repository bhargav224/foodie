package com.foodiechef.api.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("foodie_chef");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("foodie_chef");
        ...
        config.getMapConfigs().put("com.foodiechef.api.domain.*", initializeDomainMapConfig(jHipsterProperties));
